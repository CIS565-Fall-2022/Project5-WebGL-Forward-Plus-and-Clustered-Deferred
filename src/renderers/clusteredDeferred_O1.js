...
import toTextureFrag from '../shaders/deferred_O1_ToTexture.frag.glsl';
import QuadVertSource from '../shaders/quad.vert.glsl';
import fsSource from '../shaders/deferred_O1.frag.glsl.js';
...
export default class ClusteredDeferredRenderer_O1 extends BaseRenderer {
  constructor(xSlices, ySlices, zSlices) {
    ...
    this._progShade = loadShaderProgram(QuadVertSource, fsSource({
      ...
      uniforms: ['u_gbuffers[0]', 'u_gbuffers[1]', 'u_lightbuffer', 'u_clusterbuffer', 'u_canvasresolution', 'u_clusterslices', 'u_viewMatrix'],
      attribs: ['a_uv'],
    });
